...
uses
  ...
  FireDAC.Comp.Client, UDBConnectionIntf, UDBConnectionImpl;
...
//  FPedidoRepository.consultaPedido(ADocumentoCliente);
  ...
  FFDQuery.SQL.Text := 'select id, sTamanho,sSabor,vl_pedido,nr_tempopedido  from tb_pedido where id = :pDocumento order by id desc LIMIT 1';
