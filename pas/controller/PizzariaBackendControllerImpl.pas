...
type
  ...
  public
    ...
    function consultaPedido(const ADocumentoCliente: String): string; stdcall;
...
function TPizzariaBackendController.consultaPedido(const ADocumentoCliente: String): string; stdcall;
begin
  Result := FPedidoService.consultaPedido(ADocumentoCliente);
end;
