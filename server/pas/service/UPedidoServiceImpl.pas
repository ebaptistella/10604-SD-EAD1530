...
uses
  UPedidoRepositoryImpl, UClienteServiceImpl,
  FireDAC.Comp.Client;
...
begin
  ...
  try
    ...
    Result := TPedidoRetornoDTO.Create(
      TPizzaTamanhoEnum(oFDQuery.FieldByName('PizzaTamanho').asInteger),
      TPizzaSaborEnum(oFDQuery.FieldByName('PizzaSabor').asInteger),
