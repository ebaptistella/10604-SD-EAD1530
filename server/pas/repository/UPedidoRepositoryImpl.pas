...
uses
  ...
  FireDAC.Comp.Client,sysutils,typinfo,UPedidoRetornoDTOImpl;
...
uses
  UDBConnectionImpl, Data.DB, FireDAC.Stan.Param;
...
const
 ...
 : String =
  'SELECT en_tamanho, en_sabor, vl_pedido, nr_tempopedido '+
